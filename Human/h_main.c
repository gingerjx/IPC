...
///////// Threads init
    log("Threads...");
        ...
        sem_post(sem_crit);     //waiting for opened server
    log(" done\n"); 
/////////
///////// Starting Game
    log("Starting game\n");
...
///////// Closing server
    ...
    close_connections(serv_fd,cl_fd,serv_msg,cl_msg,sem_crit,sem_join,ptInput);
    log("[ %d ] Close client\n", getpid());
	return 0;
}
